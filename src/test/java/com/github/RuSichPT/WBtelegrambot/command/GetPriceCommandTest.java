...
public class GetPriceCommandTest extends AbstractPriceCommandTest{
    ...
    public void shouldCorrectlyExecuteCommand1(){
        ...
        String answer = "Чтобы получить информацию по номенклатурам, их ценам, скидкам и промокодам введите данные в виде:\n"
    ...
    public void shouldCorrectlyExecuteCommand2(){
        ...
        String answer =  String.format("Номенклатура товара: %s\n" +
                "Цена: %s\n" + "Скидка: %s\n" + "Промокод: %s\n\n",
